...
public class DBMCheckLogin {
	String pass = "";
	String result ="";
	public DBMCheckLogin(String user ,String password) throws ClassNotFoundException{
		Connection conn;
		Statement stmt;
		ResultSet res;
...
//		stmt.execute("update userlist set online = 'true' where username like '" +user +"'");
		res = stmt.executeQuery("select * from USERLIST where username like '"+user+"'");
